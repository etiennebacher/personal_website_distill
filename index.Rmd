...
I develop or contribute to many R packages, all of which you can find on my [GitHub profile](https://github.com/etiennebacher/). I also write occasional blog articles about R and I have given some training on several topics, available in the "Software" tab above.
