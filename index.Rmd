...
<li style = "list-style: none; background-image: url(graduation-cap-solid.png); background-repeat: no-repeat;  background-size: 1.2rem; padding-left: 2rem;">   PhD in Economics of Migration, 2020 - current, LISER </li>
<br>
