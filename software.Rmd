...
**At the Center for Applied Public Economics (Brussels, January 2026)**

* [Handling large data in Python and R](https://brussels-large-data-r-python.etiennebacher.com): a tutorial on handling datasets with tens of millions of observations using Polars (and tidypolars) in Python and R.
