...
* [`lintr`](https://lintr.r-lib.org/): this R package provides dozens of rules for linting R code, and Jarl wouldn't exist without this package. Jarl currently supports 25 `lintr` rules.
...
As I said above, Jarl depends enormously on the work of `lintr` and Air [developers](https://lintr.r-lib.org/authors.html), so thank you!
...
And thank you, Maëlle, for proofreading the draft!
